...
public enum LocationGroup {
	...
	NORTH_LOCATION(
		List.of(Location.Aewol_eup, Location.Jeju_si, Location.Jocheon_eup, Location.Gujwa_eup, Location.Udo_myeon,
			Location.Chuja_myeon), "북부"),
	EAST_LOCATION(List.of(Location.Namwon_eup, Location.Pyoseon_myeon, Location.Seongsan_eup), "동부"),
	WEST_LOCATION(List.of(Location.Hallim_eup, Location.Hangyeong_myeon, Location.Daejeong_eup, Location.Andeok_myeon),
		"서부"),
	...
	ALL_LOCATION(List.of(Location.Jeju_si, Location.Aewol_eup, Location.Hallim_eup,
		...
		Location.Namwon_eup, Location.Pyoseon_myeon, Location.Seongsan_eup, Location.Udo_myeon, Location.Chuja_myeon),
		"전체");
